...
./bismark --genome $ARAPORT11 --temp_dir $SCRATCH --output_dir $OUTPUT_DIR -p 4 -1 $INPUT_DIR/trim_williams/SRR17281085_1_val_1.fq -2 $INPUT_DIR/trim_williams/SRR17281085_2_val_2.fq