...
#running ideally the exact same processing on the RNAseq reads. Will be fun! 
...
INPUT=/global/scratch/users/chandlersutherland/e14/polyester/primary_simulated_reads_1004
